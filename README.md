...
| 企业级网关（认证/限流/多租户/计量）+ Spring Boot Starter | MVP6 |
...
```
┌────────────────────────────────────────────────────────────────┐
│  sprinkle-claw-app / sprinkle-claw-spring-boot-starter         │  可选启动层 (规划)
├────────────────────────────────────────────────────────────────┤
│  sprinkle-claw-gateway    │  sprinkle-claw-server              │  可选服务层 (规划)
├───────────────────────────┼────────────────────────────────────┤
...
| `sprinkle-claw-spring-boot-starter` | Spring Boot 自动配置 | core, server | 📋 MVP6 |
