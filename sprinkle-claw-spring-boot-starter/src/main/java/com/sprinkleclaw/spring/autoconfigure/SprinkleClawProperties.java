 ...
 * @since 0.7.0 (MVP6)
 */
@ConfigurationProperties(prefix = "sprinkle-claw")
public class SprinkleClawProperties {
    ...
    public static class Agent {
        ...
        public int getCompactionThreshold() { return compactionThreshold; }
        public void setCompactionThreshold(int compactionThreshold) { this.compactionThreshold = compactionThreshold; }
    ...
    public static class Tools {
        ...
        public boolean isBuiltinEnabled() { return builtinEnabled; }
        public void setBuiltinEnabled(boolean builtinEnabled) { this.builtinEnabled = builtinEnabled; }
    ...
    public static class Acl {
        ...
        public void setIpBlacklist(List<String> ipBlacklist) { this.ipBlacklist = ipBlacklist; }
    ...
    public static class Security {
        ...
        public boolean isPromptInjectionGuardEnabled() { return promptInjectionGuardEnabled; }
        ...
        public boolean isOutputValidatorEnabled() { return outputValidatorEnabled; }
