 ...
 * @since 0.7.0 (MVP6)
 */
public final class SprinkleLoomMcpServer implements AutoCloseable {

    private static final String DEFAULT_NAME = "sprinkle-loom";
    private static final String DEFAULT_VERSION = "0.7.0";

    private final McpSyncServer server;

    public SprinkleLoomMcpServer(ToolRegistry registry) {
        this(registry, DEFAULT_NAME, DEFAULT_VERSION);
    }

    public SprinkleLoomMcpServer(ToolRegistry registry, String name, String version) {
