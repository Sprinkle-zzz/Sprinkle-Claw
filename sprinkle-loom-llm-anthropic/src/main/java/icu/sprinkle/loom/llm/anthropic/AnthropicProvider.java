package icu.sprinkle.loom.llm.anthropic;
...
public final class AnthropicProvider implements LlmProvider {
    ...
    private String buildRequestBody(ChatRequest request, boolean stream) {
        ...
        if (!request.systemPrompt().isEmpty()) {
            if (request.systemCacheControl() instanceof icu.sprinkle.loom.protocol.message.CacheControl.Ephemeral) {
    ...
    private void addCacheControl(ObjectNode node, icu.sprinkle.loom.protocol.message.CacheControl cc) {
        if (cc instanceof icu.sprinkle.loom.protocol.message.CacheControl.Ephemeral) {
