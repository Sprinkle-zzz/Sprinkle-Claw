...
import com.sprinkleclaw.mcp.health.McpHealthState;
    ...
    void pingAll_should_record_failure_and_set_state_DOWN_after_threshold() throws Exception {
        ...
        try {
            ...
            McpProcessManager manager = spy(new McpProcessManager(
                    com.sprinkleclaw.mcp.config.McpServerConfig.builder("svc")
                            .transport(com.sprinkleclaw.mcp.config.McpServerConfig.Transport.STDIO)
                            .command("echo").build()));
